...
Generated: 2026-07-28T23:28:59.041652+00:00
...
### Added
- Yearn V3 - Sherlock (score 12, HIGH)

## Alerts (new HIGH/MEDIUM, actionable)

- **Yearn V3 - Sherlock** — HIGH (score 12), rep 0, critical $200,000. Phase 0 clean at 6c4ccc8. Base Vault.vy/TokenizedStrategy.sol/BaseStrategy.sol excluded as Immunefi duplicates; yRoboTreasury custom paths reduce to trusted roles + accepted auction risks. Sherlock scope is DYNAMIC (yearn.fi/v3). Revisit when a custom strategy is added, yRoboTreasury changes, or a strategy introduces custom valuation/withdrawal/reporting logic.
